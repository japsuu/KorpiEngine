...
public sealed class Texture2DArray : Texture
{
    ...
    /// <param name="rectHeight">The height of the rectangle of pixels to write.</param>
    /// <param name="rectDepth">The depth of the rectangle of pixels to write.</param>
    public unsafe void SetData<T>(ReadOnlySpan<T> data, int rectX, int rectY, int rectZ, int rectWidth, int rectHeight, int rectDepth) where T : unmanaged
    {
        ValidateRectOperation(rectX, rectY, rectZ, rectWidth, rectHeight, rectDepth);
    ...
    private void ValidateRectOperation(int rectX, int rectY, int rectZ, int rectWidth, int rectHeight, int rectDepth)
    {
