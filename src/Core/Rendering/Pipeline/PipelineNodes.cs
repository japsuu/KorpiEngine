...
public class LightingCombinePassNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _combineShader ??= new Material(Asset.Load<Shader>("Assets/Defaults/GBufferCombine.kshader"), "G-buffer combine material", false);
...
public class ProceduralSkyboxNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _mat ??= new Material(Asset.Load<Shader>("Assets/Defaults/ProceduralSkybox.kshader"), "procedural skybox material", false);
...
public class ScreenSpaceReflectionNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _mat ??= new Material(Asset.Load<Shader>("Assets/Defaults/SSR.kshader"), "SSR material", false);
        _mat.SetTexture("_GColor", source.MainTexture);
...
public class TAANode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _mat ??= new Material(Asset.Load<Shader>("Assets/Defaults/TAA.kshader"), "TAA material", false);
        _mat.SetTexture("_GColor", source.MainTexture);
...
public class DepthOfFieldNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _mat ??= new Material(Asset.Load<Shader>("Assets/Defaults/DOF.kshader"), "DOF material", false);
...
public class BloomNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _mat ??= new Material(Asset.Load<Shader>("Assets/Defaults/Bloom.kshader"), "bloom material", false);
...
public class TonemappingNode : RenderPassNode
{
    ...
    protected override RenderTexture? Render(RenderTexture? source)
    {
        ...
        _acesMat ??= new Material(Asset.Load<Shader>("Assets/Defaults/Tonemapper.kshader"), "tonemapping material", false);
