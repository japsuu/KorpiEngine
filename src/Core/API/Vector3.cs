...
public struct Vector3 : IEquatable<Vector3>, IFormattable
{
    ...
    public double Magnitude => Mathd.Sqrt(X * X + Y * Y + Z * Z);
    ...
    public static Vector3 SmoothDamp(Vector3 current, Vector3 target, ref Vector3 currentVelocity, double smoothTime, double maxSpeed = Mathd.INFINITY,
