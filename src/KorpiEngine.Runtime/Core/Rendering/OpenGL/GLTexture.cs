...
internal sealed class GLTexture : GraphicsTexture
{
        ...
        out PixelFormat pixelFormat)
    {
        ...
        pixelInternalFormat = imageFormat switch
        {
            ...
            TextureImageFormat.R_16_F => PixelInternalFormat.R16,
            TextureImageFormat.RG_16_F => PixelInternalFormat.Rg16,
            TextureImageFormat.RGB_16_F => PixelInternalFormat.Rgb16,
            TextureImageFormat.RGBA_16_F => PixelInternalFormat.Rgba16,
            TextureImageFormat.R_16_UF => PixelInternalFormat.R16,
            TextureImageFormat.RG_16_UF => PixelInternalFormat.Rg16,
            TextureImageFormat.RGB_16_UF => PixelInternalFormat.Rgb16,
            TextureImageFormat.RGBA_16_UF => PixelInternalFormat.Rgba16,
